...
export const FURY_ATTRIBUTE_BONUS_BY_SIZE = FURY.attributeBonusBySize;
export const FURY_MOON_ATTRIBUTE_BONUS = FURY.moonAttributeBonus;
...
export const REST_WILLPOWER_MAX_BONUS = RECOVERY.willpowerMaxBonus;
export const REST_WILLPOWER_HALF = RECOVERY.willpowerHalf;
...
export const PET_MIN_LEVEL = 200;
...
export const MINING_DAILY_MININGS = 150;
