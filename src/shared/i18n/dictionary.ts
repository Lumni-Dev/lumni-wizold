...
const RULES: readonly PatternRule[] = [
  ...
  {
    pattern: /^(.+) brewed: (.+) x(\d+), (.+) x(\d+) and one empty flask spent\.$/,
    en: "$1 brewed: $2 x$3, $4 x$5 and one empty flask spent.",
    pt: "$1 fabricada: $2 x$3, $4 x$5 e um frasco vazio gastos.",
    es: "$1 fabricada: $2 x$3, $4 x$5 y un frasco vacío gastados.",
  },
