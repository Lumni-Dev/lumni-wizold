...
const RULES: readonly PatternRule[] = [
  ...
  {
    pattern: /^Each training is paid on the spot: it costs (.+) and you are (.+) short\.$/,
    en: "Each training is paid on the spot: it costs $1 and you are $2 short.",
    pt: "Cada treino é pago na hora: custa $1 e faltam $2.",
    es: "Cada entrenamiento se paga al momento: cuesta $1 y te faltan $2.",
  },
  {
  ...
  {
    pattern: /^(.+): stop it before starting another\.$/,
    en: "$1: stop it before starting another.",
    pt: "$1: pare antes de começar outra.",
  ...
  { pattern: /^Leave the pack with (.+)$/, en: "Leave the pack with $1", pt: "Sair da matilha com $1", es: "Salir de la manada con $1" },
  { pattern: /^Hear about (.+)$/, en: "Hear about $1", pt: "Ouvir sobre $1", es: "Escuchar sobre $1" },
  { pattern: /^Password of table (.+)$/, en: "Password of table $1", pt: "Senha da mesa $1", es: "Contraseña de la mesa $1" },
  { pattern: /^Message at table (.+)$/, en: "Message at table $1", pt: "Mensagem na mesa $1", es: "Mensaje en la mesa $1" },
  { pattern: /^Insert (.+)$/, en: "Insert $1", pt: "Inserir $1", es: "Insertar $1" },
  { pattern: /^You have (.+)\.$/, en: "You have $1.", pt: "Você tem $1.", es: "Tienes $1." },
  { pattern: /^Sell for (.+)$/, en: "Sell for $1", pt: "Vender por $1", es: "Vender por $1" },
  { pattern: /^Pay (.+)$/, en: "Pay $1", pt: "Pagar $1", es: "Pagar $1" },
  { pattern: /^Copy the (.+)$/, en: "Copy the $1", pt: "Copiar o $1", es: "Copiar el $1" },
  { pattern: /^Close notice from (.+)$/, en: "Close notice from $1", pt: "Fechar aviso de $1", es: "Cerrar aviso de $1" },
  { pattern: /^Close chat of (.+)$/, en: "Close chat of $1", pt: "Fechar chat de $1", es: "Cerrar chat de $1" },
  { pattern: /^Close (.+)$/, en: "Close $1", pt: "Fechar $1", es: "Cerrar $1" },
  { pattern: /^(\d+) \/ (\d+) people$/, en: "$1 / $2 people", pt: "$1 / $2 pessoas", es: "$1 / $2 personas" },
  { pattern: /^(\d[\d.,]*) of (\d+) attacks$/, en: "$1 of $2 attacks", pt: "$1 de $2 ataques", es: "$1 de $2 ataques" },
  { pattern: /^(\d+) of (\d+)$/, en: "$1 of $2", pt: "$1 de $2", es: "$1 de $2" },
  ...
  { pattern: /^Draw with (.+)$/, en: "Draw with $1", pt: "Empate com $1", es: "Empate con $1" },
  { pattern: /^Back in (.+)$/, en: "Back in $1", pt: "Volta em $1", es: "Vuelve en $1" },
  { pattern: /^Buy for (.+)$/, en: "Buy for $1", pt: "Comprar por $1", es: "Comprar por $1" },
  { pattern: /^Adopt for (.+)$/, en: "Adopt for $1", pt: "Adotar por $1", es: "Adoptar por $1" },
  { pattern: /^Change for (.+)$/, en: "Change for $1", pt: "Alterar por $1", es: "Cambiar por $1" },
  { pattern: /^Copy (.+)$/, en: "Copy $1", pt: "Copiar $1", es: "Copiar $1" },
  { pattern: /^(.+) copied$/, en: "$1 copied", pt: "$1 copiado", es: "$1 copiado" },
  { pattern: /^Available: ([\d.,]+)\.$/, en: "Available: $1.", pt: "Disponível: $1.", es: "Disponible: $1." },
  { pattern: /^Continue as (.+)$/, en: "Continue as $1", pt: "Continuar como $1", es: "Continuar como $1" },
  {
    pattern: /^Companion - Experience \(LV\. (.+)\)$/,
    en: "Companion - Experience (LV. $1)",
    pt: "Mascote - Experiência (NV. $1)",
    es: "Mascota - Experiencia (NV. $1)",
  },
  {
    pattern: /^Training repeats on its own until you say stop, and each attribute caps at ([\d.,]+)\.$/,
    en: "Training repeats on its own until you say stop, and each attribute caps at $1.",
    pt: "O treino se repete sozinho até você mandar parar, e cada atributo para em $1.",
    es: "El entrenamiento se repite solo hasta que digas parar, y cada atributo se detiene en $1.",
  },
  {
    pattern: /^Each click trains one session, and each attribute caps at ([\d.,]+)\.$/,
    en: "Each click trains one session, and each attribute caps at $1.",
    pt: "Cada clique treina uma sessão, e cada atributo para em $1.",
    es: "Cada clic entrena una sesión, y cada atributo se detiene en $1.",
  },
  {
    pattern: /^Chat tables for up to ([\d.,]+) people, with or without a password\. A table closes itself when the last person leaves\.$/,
    en: "Chat tables for up to $1 people, with or without a password. A table closes itself when the last person leaves.",
    pt: "Mesas de conversa para até $1 pessoas, com ou sem senha. Uma mesa se fecha quando a última pessoa sai.",
    es: "Mesas de charla para hasta $1 personas, con o sin contraseña. Una mesa se cierra cuando la última persona sale.",
  },
  {
    pattern: /^A table without a password takes LV ([\d.,]+) and up, or VIP\. Set a password to open at any level\.$/,
    en: "A table without a password takes LV $1 and up, or VIP. Set a password to open at any level.",
    pt: "Mesa sem senha pede NV $1 para cima, ou VIP. Defina uma senha para abrir em qualquer nível.",
    es: "Una mesa sin contraseña pide NV $1 en adelante, o VIP. Define una contraseña para abrir en cualquier nivel.",
  },
