...
const RULES: readonly PatternRule[] = [
  ...
  {
    pattern: /^(.+) demands alchemy LV\. (\d+)\.$/,
    en: "$1 demands alchemy LV. $2.",
    pt: "$1 exige alquimia NV. $2.",
    es: "$1 exige alquimia NV. $2.",
  },
  ...
  },
  {
    ...
    es: "$1 fabricada: $2 x$3, $4 x$5, un pergamino y un frasco vacío gastados.",
  },
  ...
  { pattern: /^Minimize chat of (.+)$/, en: "Minimize chat of $1", pt: "Minimizar chat de $1", es: "Minimizar chat de $1" },
  { pattern: /^Open chat of (.+)$/, en: "Open chat of $1", pt: "Abrir chat de $1", es: "Abrir chat de $1" },
  { pattern: /^Chat of (.+)$/, en: "Chat of $1", pt: "Chat de $1", es: "Chat de $1" },
  { pattern: /^Close (.+)$/, en: "Close $1", pt: "Fechar $1", es: "Cerrar $1" },
  { pattern: /^(\d+) \/ (\d+) person$/, en: "$1 / $2 person", pt: "$1 / $2 pessoa", es: "$1 / $2 persona" },
  ...
  { pattern: /^Reset in (.+)\.$/, en: "Reset in $1.", pt: "Faltam $1 para resetar.", es: "Faltan $1 para reiniciar." },
  ...
  { pattern: /^Best at (.+) - (\d[\d.,]*)º$/, en: "Best at $1 - $2º", pt: "Melhor em $1 - $2º", es: "Mejor en $1 - $2º" },
  { pattern: /^LV\. (\d[\d.,]*) to (\d[\d.,]*)$/, en: "LV. $1 to $2", pt: "NV. $1 a $2", es: "NV. $1 a $2" },
  ...
  { pattern: /^VIP is already active until (.+)\.$/, en: "VIP is already active until $1.", pt: "O VIP já está ativo até $1.", es: "El VIP ya está activo hasta $1." },
  { pattern: /^VIP active until (.+)\.$/, en: "VIP active until $1.", pt: "VIP ativo até $1.", es: "VIP activo hasta $1." },
  ...
  { pattern: /^The minimum is (.+)\.$/, en: "The minimum is $1.", pt: "O mínimo é $1.", es: "El mínimo es $1." },
  { pattern: /^by (.+)$/, en: "by $1", pt: "por $1", es: "por $1" },
  { pattern: /^(.+) credited: (.+) for (.+)\.$/, en: "$1 credited: $2 for $3.", pt: "$1 creditado: $2 por $3.", es: "$1 acreditado: $2 por $3." },
  { pattern: /^(.+) → \+(\d[\d.,]*) - costs (\d[\d.,]*) (.+) and (.+)$/, en: "$1 → +$2 - costs $3 $4 and $5", pt: "$1 → +$2 - custa $3 $4 e $5", es: "$1 → +$2 - cuesta $3 $4 y $5" },
  { pattern: /^Forging costs (.+)$/, en: "Forging costs $1", pt: "Forjar custa $1", es: "Forjar cuesta $1" },
  { pattern: /^Requires LV (\d+)$/, en: "Requires LV $1", pt: "Exige NV $1", es: "Exige NV $1" },
  { pattern: /^Expires in (.+)\.$/, en: "Expires in $1.", pt: "Expira em $1.", es: "Expira en $1." },
  { pattern: /^Take off \((.+)\)$/, en: "Take off ($1)", pt: "Tirar ($1)", es: "Quitar ($1)" },
  { pattern: /^No items of (.+)$/, en: "No items of $1", pt: "Nenhum item de $1", es: "Ningún objeto de $1" },
  {
    pattern: /^Payment in a currency foreign to the game: (.+)\.$/,
    en: "Payment in a currency foreign to the game: $1.",
    pt: "Pagamento em moeda estranha ao jogo: $1.",
    es: "Pago en una moneda ajena al juego: $1.",
  },
  {
    pattern: /^The payment does not match the pack: (.+)\.$/,
    en: "The payment does not match the pack: $1.",
    pt: "O pagamento não bate com o pacote: $1.",
    es: "El pago no coincide con el paquete: $1.",
  },
  {
    pattern: /^VIP subscription without an identifier: (.+)\.$/,
    en: "VIP subscription without an identifier: $1.",
    pt: "Assinatura VIP sem identificador: $1.",
    es: "Suscripción VIP sin identificador: $1.",
  },
  {
    pattern: /^The listing left the board before the payment arrived: (.+)\.$/,
    en: "The listing left the board before the payment arrived: $1.",
    pt: "O anúncio saiu do quadro antes do pagamento chegar: $1.",
    es: "El anuncio salió del tablero antes de que llegara el pago: $1.",
  },
  {
    pattern: /^The payment does not match the listing: (.+)\.$/,
    en: "The payment does not match the listing: $1.",
    pt: "O pagamento não bate com o anúncio: $1.",
    es: "El pago no coincide con el anuncio: $1.",
  },
