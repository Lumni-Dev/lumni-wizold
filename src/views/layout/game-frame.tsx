    ...
    <>
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <div className="flex min-h-screen w-full min-w-0 flex-col">
          <div className="sticky top-0 z-20 mx-auto w-full max-w-6xl px-4 pt-2.5 md:px-8">
            <ResourceBar />
          </div>
          <MobileNavigation
            tavernUnread={asideUnread}
            ...
            onOpenTutorial={() => setReviewTutorial(true)}
          />
          <div className="mx-4 mt-2.5 rounded-lg border border-edge bg-surface/40 px-3 py-2 lg:hidden">
            <MoonTracker />
          </div>
