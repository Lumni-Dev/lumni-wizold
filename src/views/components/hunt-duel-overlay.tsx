        ...
        <span className={cn("relative inline-flex", hunterShaking && hunterPhase === "alive" && "card-shake")}>
          ...
          {slashSide === "theirs" ? (
            ...
            <img
              ...
              src={CLAW_SLASH}
              alt=""
              className="absolute left-1/2 top-[8%] z-20 h-14 w-20 -translate-x-1/2 object-contain mix-blend-screen -scale-x-100 -scale-y-100 sm:h-16 sm:w-24"
            />
          ) : null}
        </span>
        <span className={cn("relative inline-flex", preyShaking && preyPhase === "alive" && "card-shake")}>
          ...
          {slashSide === "ours" ? (
            ...
            <img
              ...
              src={CLAW_SLASH}
              alt=""
              className="absolute left-1/2 top-[8%] z-20 h-14 w-20 -translate-x-1/2 object-contain mix-blend-screen -scale-y-100 sm:h-16 sm:w-24"
            />
          ) : null}
        </span>
      </div>
