...
// A session is "userId.expiryMs.hmac", signed with SESSION_SECRET and carried
// in an httpOnly cookie: the browser can never read or forge it, and every
// request re-verifies the signature before touching the database.
...
// Tavern table keys never touch the database in clear: scrypt with a salt per
// room, packed as "salt:hash".
