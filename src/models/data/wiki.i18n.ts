  ...
  return [
    ...
    },
    {
      ...
      lines: [
        ...
        "Libera todos os interruptores de automação nas configurações: caçada, treino, mina, forja, alquimia, descanso, fúria, poção e mascote.",
  ...
  return [
    ...
    },
    {
      ...
      lines: [
        ...
        "Desbloquea todos los interruptores de automatización en la configuración: cacería, entrenamiento, mina, forja, alquimia, descanso, furia, poción y compañero.",
