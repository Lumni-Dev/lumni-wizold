...
// English is the source; lore.i18n.ts carries the Portuguese and Spanish packs.
// The unsuffixed voice path is the Portuguese recording; localizedVoice() in
// lore.i18n.ts derives the ".en"/".es" files rendered by narrate-lore.mjs.
export const LORE_COUPLE = {
  male: { name: "Lumni", title: "The one who let go first" },
  female: { name: "Luna", title: "The one who knew how to hold" },
};
